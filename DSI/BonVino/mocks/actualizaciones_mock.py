...
vinos_a_actualizar_mock = [
    Vino("Vino A1", 1918, "imagenA1.jpg", "Notas de frutos rojos y especias", 2550.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino B1", 1917, "imagenB1.jpg", "Aromas a ciruela y roble", 3000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino C1", 1919, "imagenC1.jpg", "Cuerpo robusto y taninos suaves", 4500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino D1", 1916, "imagenD1.jpg", "Notas de vainilla y chocolate", 5000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino E1", 1920, "imagenE1.jpg", "Aromas florales y cítricos", 3500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino F1", 1915, "imagenF1.jpg", "Especiado con final largo", 6000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino G12", 1918, "imagenG1.jpg", "Notas de frutas maduras", 4000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[2]),
    Vino("Vino H1", 1917, "imagenH1.jpg", "Notas de mora y regaliz", 5500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[7]),
    Vino("Vino I1", 1919, "imagenI1.jpg", "Estructurado con final persistente", 6500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[7]),
    Vino("Vino J1", 1916, "imagenJ1.jpg", "Notas a cacao y tabaco", 7000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[7]),
    Vino("Vino K1", 1920, "imagenK1.jpg", "Notas cítricas y minerales", 4500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[7]),
    Vino("Vino L1", 1915, "imagenL1.jpg", "Especiado con final persistente", 7500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[7]),
    Vino("Vino M12", 1918, "imagenM1.jpg", "Aromas a frutas tropicales", 3500.0, "2024-05-26", [Varietal("Varietal de Cabernet Franc, 50% Cabernet Franc", 50, tipos_uva_mock[19]), Varietal("50% Sangiovese", 50, tipos_uva_mock[14])], [maridajes_mock[0]], bodegas_mock[7]),
    Vino("Vino N12", 1917, "imagenN1.jpg", "Notas de manzana y pera", 4000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[11]),
    Vino("Vino O1", 1919, "imagenO1.jpg", "Estructurado con final largo", 5500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[11]),
    Vino("Vino P1", 1916, "imagenP1.jpg", "Notas de cereza y especias", 6000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[11]),
    Vino("Vino Q1", 1920, "imagenQ1.jpg", "Aromas a durazno y melón", 4500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[11]),
    Vino("Vino R1", 1915, "imagenR1.jpg", "Especiado con final persistente", 7000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[11]),
    Vino("Vino S1", 1918, "imagenS1.jpg", "Notas de frutos rojos y especias", 2550.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[11]),
    Vino("Vino T1", 1917, "imagenT1.jpg", "Aromas a ciruela y roble", 3000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[13]),
    Vino("Vino U12", 1919, "imagenU1.jpg", "Cuerpo robusto y taninos suaves", 4500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[13]),
    Vino("Vino V1", 1916, "imagenV1.jpg", "Notas de vainilla y chocolate", 5000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[13]),
    Vino("Vino W1", 1920, "imagenW1.jpg", "Aromas florales y cítricos", 3500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[14]),
    Vino("Vino X1", 1915, "imagenX1.jpg", "Especiado con final largo", 6000.0, "2024-05-26", [varietales_mock[1]], [], bodegas_mock[14]),
    Vino("Vino Y1", 1918, "imagenY1.jpg", "Notas de frutas maduras", 4000.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[14]),
    Vino("Vino Z12", 1917, "imagenZ1.jpg", "Notas de mora y regaliz", 5500.0, "2024-05-26", [varietales_mock[1]], [maridajes_mock[0]], bodegas_mock[14])
]
