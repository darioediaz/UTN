...
vinos_mock = [
    Vino("Vino A1", 2018, "imagenA1.jpg", "Notas de frutos rojos y especias", 2550.0, "2024-05-26", varietal_malbec, [maridaje_carnes_rojas], bodegas_mock[2]),
    Vino("Vino B1", 2017, "imagenB1.jpg", "Aromas a ciruela y roble", 3000.0, "2024-05-26", varietal_cabernet_sauvignon, [maridaje_quesos_curados], bodegas_mock[2]),
    Vino("Vino C1", 2019, "imagenC1.jpg", "Cuerpo robusto y taninos suaves", 4500.0, "2024-05-26", varietal_merlot, [maridaje_pasta], bodegas_mock[2]),
    Vino("Vino D1", 2016, "imagenD1.jpg", "Notas de vainilla y chocolate", 5000.0, "2024-05-26", varietal_syrah, [maridaje_cordero], bodegas_mock[2]),
    Vino("Vino E1", 2020, "imagenE1.jpg", "Aromas florales y cítricos", 3500.0, "2024-05-26", varietal_chardonnay, [maridaje_pescado, maridaje_bistec], bodegas_mock[2]),
    Vino("Vino F1", 2015, "imagenF1.jpg", "Especiado con final largo", 6000.0, "2024-05-26", varietal_tempranillo, [maridaje_tapas, maridaje_cordero], bodegas_mock[2]),
    Vino("Vino G1", 2018, "imagenG1.jpg", "Notas de frutas maduras", 4000.0, "2024-05-26", varietal_garnacha, [maridaje_pollo], bodegas_mock[2]),
    Vino("Vino H1", 2017, "imagenH1.jpg", "Notas de mora y regaliz", 5500.0, "2024-05-26", varietal_pinot_noir, [maridaje_setas], bodegas_mock[7]),
    Vino("Vino I1", 2019, "imagenI1.jpg", "Estructurado con final persistente", 6500.0, "2024-05-26", varietal_zinfandel, [maridaje_bbq], bodegas_mock[7]),
    Vino("Vino J1", 2016, "imagenJ1.jpg", "Notas a cacao y tabaco", 7000.0, "2024-05-26", varietal_petit_verdot, [maridaje_bistec], bodegas_mock[7]),
    Vino("Vino K1", 2020, "imagenK1.jpg", "Notas cítricas y minerales", 4500.0, "2024-05-26", varietal_sauvignon_blanc, [maridaje_ensaladas], bodegas_mock[7]),
    Vino("Vino L1", 2015, "imagenL1.jpg", "Especiado con final persistente", 7500.0, "2024-05-26", varietal_carmenere, [maridaje_embutidos, maridaje_pescado], bodegas_mock[7]),
    Vino("Vino M1", 2018, "imagenM1.jpg", "Aromas a frutas tropicales", 3500.0, "2024-05-26", varietal_viognier, [maridaje_quesos_suaves], bodegas_mock[7]),
    Vino("Vino N1", 2017, "imagenN1.jpg", "Notas de manzana y pera", 4000.0, "2024-05-26", varietal_albarino, [maridaje_mariscos], bodegas_mock[11]),
    Vino("Vino O1", 2019, "imagenO1.jpg", "Estructurado con final largo", 5500.0, "2024-05-26", varietal_sangiovese, [maridaje_pizza], bodegas_mock[11]),
    Vino("Vino P1", 2016, "imagenP1.jpg", "Notas de cereza y especias", 6000.0, "2024-05-26", varietal_barbera, [maridaje_guisos], bodegas_mock[11]),
    Vino("Vino Q1", 2020, "imagenQ1.jpg", "Aromas a durazno y melón", 4500.0, "2024-05-26", varietal_moscato, [maridaje_postres], bodegas_mock[11]),
    Vino("Vino R1", 2015, "imagenR1.jpg", "Especiado con final persistente", 7000.0, "2024-05-26", varietal_nebbiolo, [maridaje_caza], bodegas_mock[11]),
    Vino("Vino S1", 2018, "imagenS1.jpg", "Notas de frutos rojos y especias", 2550.0, "2024-05-26", varietal_grenache, [maridaje_embutidos], bodegas_mock[11]),
    Vino("Vino T1", 2017, "imagenT1.jpg", "Aromas a ciruela y roble", 3000.0, "2024-05-26", varietal_malbec, [maridaje_quesos_curados], bodegas_mock[13]),
    Vino("Vino U1", 2019, "imagenU1.jpg", "Cuerpo robusto y taninos suaves", 4500.0, "2024-05-26", varietal_cabernet_franc, [maridaje_carnes_rojas], bodegas_mock[13]),
    Vino("Vino V1", 2016, "imagenV1.jpg", "Notas de vainilla y chocolate", 5000.0, "2024-05-26", varietal_syrah, [maridaje_cordero], bodegas_mock[13]),
    Vino("Vino W1", 2020, "imagenW1.jpg", "Aromas florales y cítricos", 3500.0, "2024-05-26", varietal_chardonnay, [maridaje_pescado, maridaje_pasta], bodegas_mock[14]),
    Vino("Vino X1", 2015, "imagenX1.jpg", "Especiado con final largo", 6000.0, "2024-05-26", varietal_tempranillo, [], bodegas_mock[14]),
    Vino("Vino Y1", 2018, "imagenY1.jpg", "Notas de frutas maduras", 4000.0, "2024-05-26", varietal_garnacha, [maridaje_pollo], bodegas_mock[14]),
    Vino("Vino Z1", 2017, "imagenZ1.jpg", "Notas de mora y regaliz", 5500.0, "2024-05-26", varietal_pinot_noir, [maridaje_setas, maridaje_embutidos, maridaje_cordero], bodegas_mock[14])
]