          ...
          <div className="row">
            <div className="col-sm-4 col-md-3 offset-md-1">
              <label className="col-form-label" htmlFor="Puntuacion">
                Puntuacion<span className="text-danger">*</span>:
              </label>
            </div>
            <div className="col-sm-8 col-md-6">
              <input
                type="number" step=".01"
                {...register("Puntuacion", {
                  required: { value: true, message: "Puntuacion es requerido" },
                  min: {
                    value: 0.01,
                    message: "Puntuacion debe ser mayor a 0",
                  },
                  max: {
                    value: 99999999,
                    message: "Puntuacion debe ser menor o igual a 99999999",
                  },
                })}
                className={
                  "form-control " + (errors?.Puntuacion ? "is-invalid" : "")
                }
              />
              <div className="invalid-feedback">{errors?.Puntuacion?.message}</div>
            </div>
          </div>
