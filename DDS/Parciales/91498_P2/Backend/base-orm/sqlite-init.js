...
async function CrearBaseSiNoExiste() {
  ...
  if (!existe) {
    ...
    await db.run(`INSERT INTO proveedores (RazonSocial, Telefono, FechaAlta) VALUES 
                ('Suministros Rápidos S.A.', 153123456, '2023-01-15'),
                ('Tecnología Avanzada Ltda.', 156234567, '2023-02-20'),
                ('Papelería El Lápiz', 154345678, '2023-03-10'),
                ('Muebles Modernos S.A.', 153456789, '2023-04-05'),
                ('Electrónica del Futuro S.A.', 156567890, '2023-05-22'),
                ('Alimentos Frescos S.R.L.', 154678901, '2023-06-30'),
                ('Herramientas Profesionales Inc. S.R.L.', 153789012, '2023-07-18'),
                ('Textiles del Sur', 156890123, '2023-08-25'),
                ('Química Industrial S.A.', 154901234, '2023-09-12'),
                ('Transportes Rápidos y Seguros', 153012345, '2023-10-07')`
                )
  }
  // cerrar la base
  db.close();
